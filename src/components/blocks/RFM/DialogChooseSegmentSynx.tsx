...
import type { RFMInterface } from "@/pages/MicroSegmentation/RFM"
...
export const SyncSettingsDialog: React.FC<SyncSettingsDialogProps> = ({ open, onClose, inputData, selectBefore }) => {
    ...
    const handleSync = () => {
        ...
        const customerList = inputData?.rfm_scores.filter((customer) => customer.segment === selectedSegments)
                                ...
                                <table className="w-full text-sm">
                                    <thead className="bg-muted sticky top-0">
                                        <tr>
                                            ...
                                            <th className="px-4 py-3 text-left font-medium">Recency</th>
                                            <th className="px-4 py-3 text-left font-medium">Frequency</th>
                                            <th className="px-4 py-3 text-left font-medium">Monetary</th>
                                    ...
                                    <tbody className="divide-y divide-border">
                                        {previewData.map((row, index) => (
                                            <tr key={index} className="hover:bg-muted/50">
                                                ...
                                                <td className="px-4 py-3">{row.recency_value}</td>
                                                <td className="px-4 py-3">{row.frequency_value}</td>
                                                <td className="px-4 py-3">{row.monetary_value}</td>
